...
const Cards = () => {
  ...
  return (
    TeamInfos.map((teamInfo) => 
      <Modal 
      trigger={<Card title={teamInfo.title} subtitle={teamInfo.subtitle} style={{cursor: 'pointer'}} />} 
...
const Elements = () => {
  ...
  let footer = <Heading center color="info">This is the Cool Footer.</Heading>

  return (
    <Wrapper contain>
        <Heading size="lg" center pt="md">Buttons</Heading>
        <FlexRow pt="md">
        ...
        <FlexRow pt="md">
            <Button mode="primary" color="black" hoverColor="white" empty>Empty</Button>
        ...
        <FlexRow pt="md">
            <Card title="Test Title" subtitle="Test Subtitle" content="Lorem ipsum dolor sit amet consectetur adipisicing elit. Laborum in neque, facere blanditiis hic consectetur expedita fuga ipsum ut! Corporis!" />
            <Card header={header} footer={footer} title="This card has a header" subtitle="It also has a footer" content="Lorem ipsum dolor sit amet consectetur adipisicing elit. Laborum in neque, facere blanditiis hic consectetur expedita fuga ipsum ut! Corporis!" />
        </FlexRow>
        <FlexRow pt="md">
          <Cards />
        </FlexRow>
